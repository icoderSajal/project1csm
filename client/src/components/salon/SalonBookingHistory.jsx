...
const SalonBookingHistory = () => {
    ...
    useEffect(() => {
        ...
        const fetchBookings = async () => {
            try {
                const res = await axios.get(`http://localhost:8000/api/v1/booking-salon/user/${user._id}`, {
                    headers: {
                ...
                {bookings.map((booking) => (
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-600">
                            Appointment: <strong>{booking.appointment_date}</strong> at <strong>{booking.slot}</strong>
                        </p>
                        <div className="mt-2">
