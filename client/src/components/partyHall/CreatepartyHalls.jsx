    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(
                `http://localhost:8000/api/v1/party-hall/add`,
                payload,
                {
                    headers: {
    ...
    return (
        <>
            <div className="max-w-2xl mx-auto p-6 bg-amber-50 rounded-2xl">
                <h1 className="text-xl font-bold mb-4">Create Party Hall</h1>
...
export default CreatepartyHalls
